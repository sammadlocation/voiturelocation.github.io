   ...
   // kokizabot.addEventListener("click", ()=>{
    ...
    function nomValidate() { 
        ...
        return true;
            ...
            document.getElementById('nomerreur').innerHTML="*le nom n'est pas valide *";
            return false;
        }
        }
        function prenomValidate() { 
            ...
            return true;}
                ...
                document.getElementById('prenomerreur').innerHTML="*le prenom n'est pas valide *";
                return false;
            }
        }
      ...
      //  function telValidate() { 
          ...
          //  else{
            //    document.getElementById('telerreur').innerHTML="*le numero n'est pas valide *";
              //  return false;
            //}
            //}
